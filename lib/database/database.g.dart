...
class $BooksTable extends Books with TableInfo<$BooksTable, Book> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, categoryId, coverImagePath];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Book extends DataClass implements Insertable<Book> {
  ...
  @override
  int get hashCode => Object.hash(id, title, categoryId, coverImagePath);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Book &&
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$BooksTable, List<Book>> _booksRefsTable(
      ...
      MultiTypedResultKey.fromTable(db.books,
          aliasName:
              $_aliasNameGenerator(db.categories.id, db.books.categoryId));
                ...
                return [
                  if (booksRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$CategoriesTableReferences._booksRefsTable(db),
              ...
              addJoins: <
                ...
                if (categoryId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$BooksTableReferences._categoryIdTable(db),
                    referencedColumn:
